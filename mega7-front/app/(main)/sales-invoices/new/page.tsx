...
export default function NewSalesInvoicePage() {
  ...
  return (
    <PageShell
      icon={<ReceiptText className="h-6 w-6 text-[#2C5282]" />}
      ...
      right={
        <>
          ...
          <Button onClick={save} className="bg-[#2C5282] hover:bg-[#1A365D] text-white shadow" disabled={loading}>
    ...
    >
      ...
      <div className="flex gap-2 mb-2 flex-wrap">
        <Button
          ...
          className={mode === "so" ? "bg-[#2C5282] hover:bg-[#1A365D] text-white" : "bg-white"}
          onClick={() => setMode("so")}
        >
          Con Orden de Venta
        </Button>
        <Button
          ...
          className={mode === "direct" ? "bg-[#2C5282] hover:bg-[#1A365D] text-white" : "bg-white"}
        ...
        <Button
          ...
          className={mode === "delivery" ? "bg-[#2C5282] hover:bg-[#1A365D] text-white" : "bg-white"}
      ...
      {mode === "delivery" && (
        <div className="space-y-4">
          ...
          <Card className="border-slate-200 p-4 shadow-sm">
            <SectionHeader icon={<ShoppingCart className="h-5 w-5 text-[#2C5282]" />} title="Seleccionar Entrega" subtitle="Elegí una entrega ya despachada y pendiente de facturación." />
          ...
          {deliveryDetail && deliveryDetail.lines.length > 0 && (
            <Card className="border-slate-200 p-4 shadow-sm">
              <SectionHeader icon={<ListChecks className="h-5 w-5 text-[#2C5282]" />} title="Líneas de la Entrega" subtitle="El stock ya fue descontado al despachar. Esta factura es sólo financiera." />
              <Separator className="my-4" />
          ...
          {deliveryDetail && (
            <Card className="border-slate-200 p-4 shadow-sm">
              <SectionHeader icon={<ReceiptText className="h-5 w-5 text-[#2C5282]" />} title="Datos de la Factura" subtitle="Completá fecha, serie fiscal y condición de pago." />
              <Separator className="my-4" />
                  ...
                  <div className="flex gap-2 mt-1">
                    {(["CASH", "CREDIT"] as const).map((pt) => (
                      <button key={pt} type="button" onClick={() => setPaymentType(pt)}
                        className={`px-4 py-2 rounded-lg border text-sm font-medium transition-colors ${paymentType === pt ? "bg-[#2C5282] text-white border-[#2C5282]" : "bg-white text-gray-600 border-gray-300 hover:bg-gray-50"}`}>
      ...
      <Card className="border-slate-200 p-6 shadow-sm">
        <SectionHeader
          icon={<ShoppingCart className="h-5 w-5 text-[#2C5282]" />}
          title="Cabecera"
          subtitle={
            mode === "so"
        ...
        <SectionHeader
          icon={<CreditCard className="h-5 w-5 text-[#2C5282]" />}
              ...
              <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="flex items-center gap-3 select-none mt-6 md:mt-0">
                    <input type="checkbox" className="h-4 w-4 accent-[#2C5282]" checked={creditInstallments} onChange={(e) => setCreditInstallments(e.target.checked)} />
      ...
      <Card className="border-slate-200 p-6 shadow-sm">
        <SectionHeader
          icon={<ListChecks className="h-5 w-5 text-[#2C5282]" />}
        ...
        {mode === "direct" && (
          <div>
            ...
            <Button
              className="mt-4 border border-[#2C5282] text-[#2C5282] bg-white hover:bg-blue-50"
              variant="outline"
