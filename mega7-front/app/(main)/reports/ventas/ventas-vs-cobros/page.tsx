    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex gap-2 items-center flex-wrap">
          ...
          className="border rounded-lg px-3 py-2 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[#2C5282]"
        >
          {years.map((y) => (
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          { label: "Total facturado", value: totalVentas, color: "text-[#2C5282]" },
        ...
        {loading ? (
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={data} margin={{ top: 4, right: 16, left: 0, bottom: 0 }}>
              ...
              <Legend />
              <Bar dataKey="sales"     name="Ventas"  fill="#2C5282" radius={[4, 4, 0, 0]} />
        ...
        {loading ? (
          ...
          <ResponsiveContainer width="100%" height={260}>
            ...
            >
              ...
              <Tooltip formatter={(v) => [`₲ ${money(Number(v ?? 0))}`, ""]} labelStyle={{ fontWeight: 600 }} />
              <Legend />
              <Line type="monotone" dataKey="accSales"     name="Ventas acum."  stroke="#2C5282" strokeWidth={2} dot={false} />
