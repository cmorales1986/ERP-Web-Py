      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex gap-2 flex-wrap items-center">
          ...
          <input
            ...
            className="no-print border rounded-lg px-3 py-2 text-sm bg-white w-56 focus:outline-none focus:ring-2 focus:ring-[#2C5282]"
          />
        </div>
      </div>
          ...
          <table className="w-full text-sm min-w-[800px]">
            ...
            <tfoot className="bg-gray-50 font-semibold">
              <tr>
                ...
                <td className="px-4 py-3 text-right text-[#2C5282]">₲ {money(grandTotal)}</td>
              </tr>
            </tfoot>
          </table>
        )}
