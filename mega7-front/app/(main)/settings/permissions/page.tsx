    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-[#2C5282]/10 rounded-lg">
            <Shield className="text-[#2C5282]" size={24} />
          </div>
          <div>
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[#2C5282] hover:bg-[#1A365D] text-white px-5 py-2.5 rounded-lg font-medium transition disabled:opacity-50 disabled:cursor-not-allowed shadow"
        >
          {saving ? (
              ...
              <button
                ...
                className={`px-4 py-1.5 rounded-full text-sm font-medium transition border ${
                  selectedRole === role
                    ...
                    : "bg-white text-gray-700 border-gray-200 hover:border-[#2C5282] hover:text-[#2C5282]"
                }`}
              >
                {role}
              </button>
                  ...
                  >
                    ...
                    >
                      <input
                        ...
                        className="w-4 h-4 accent-[#2C5282] cursor-pointer"
                      />
                    </button>
                      ...
                      {groupPerms.map((perm) => (
                        ...
                        >
                          <input
                            ...
                            className="w-4 h-4 accent-[#2C5282] cursor-pointer flex-shrink-0"
                          />
      ...
      <div className="flex justify-end pb-4">
        <button
          onClick={save}
          disabled={saving || loading || !selectedRole}
          className="flex items-center gap-2 bg-[#2C5282] hover:bg-[#1A365D] text-white px-6 py-2.5 rounded-lg font-medium transition disabled:opacity-50 shadow"
        >
