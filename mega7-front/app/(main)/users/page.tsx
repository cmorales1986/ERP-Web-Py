    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <Card className="border-slate-200 p-6 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          ...
          <Button onClick={() => setRoleOpen(true)} className="bg-[#2C5282] hover:bg-[#1A365D] text-white shadow">
      ...
      <Dialog open={roleOpen} onOpenChange={(v) => { setRoleOpen(v); if (!v) { setNewRoleName(""); setNewRoleDesc(""); } }}>
        <DialogContent className="sm:max-w-[420px] bg-white">
          ...
          <DialogFooter className="gap-2">
            ...
            <Button onClick={createRole} disabled={savingRole} className="bg-[#2C5282] hover:bg-[#1A365D] text-white">Crear Rol</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
