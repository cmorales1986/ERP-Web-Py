    ...
    <PageShell
      ...
      right={
        <div className="flex gap-2">
          ...
          <Button onClick={saveOutput} className="bg-[#2C5282] hover:bg-[#1A365D] text-white shadow">
        ...
        <DialogContent className="bg-white rounded-xl shadow-xl border p-6 max-w-3xl">
          ...
          <div className="space-y-5">
            ...
            <div className="flex justify-end gap-3 pt-2">
              ...
              <Button className="bg-[#2C5282] text-white" onClick={saveLineFromModal}>
                Guardar línea
              </Button>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  className="bg-[#2C5282] text-white"
                  onClick={() => {
