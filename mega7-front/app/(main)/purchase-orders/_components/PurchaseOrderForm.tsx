...
export default function PurchaseOrderForm({ editingId }: { editingId?: number }) {
  ...
  return (
    <PageShell
      icon={<ClipboardList className="h-6 w-6 text-[#2C5282]" />}
      ...
      right={
        <>
          ...
          <Button onClick={save} className="bg-[#2C5282] hover:bg-[#1A365D] text-white shadow">
            Guardar
          </Button>
        </>
      }
    >
              ...
              <PopoverTrigger asChild>
                <button
                  ...
                  className={cn(
                    ...
                    "hover:bg-gray-50",
                    "focus:outline-none focus:ring-2 focus:ring-[#2C5282]/30 focus:border-[#2C5282]/40"
                  )}
                >
      ...
      <Card className="border-slate-200 p-6 shadow-sm">
        <SectionHeader
          icon={<ClipboardList className="h-5 w-5 text-[#2C5282]" />}
          title="Líneas"
