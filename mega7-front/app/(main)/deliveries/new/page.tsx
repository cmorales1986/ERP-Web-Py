  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2 mb-2">
        <Button variant={mode === "so" ? "default" : "outline"} className={mode === "so" ? "bg-[#2C5282] hover:bg-[#1A365D] text-white" : "bg-white"} onClick={() => setMode("so")}>
          Con Orden de Venta
        </Button>
        <Button variant={mode === "direct" ? "default" : "outline"} className={mode === "direct" ? "bg-[#2C5282] hover:bg-[#1A365D] text-white" : "bg-white"} onClick={() => setMode("direct")}>
      ...
      <Card className="border-slate-200 p-6 shadow-sm">
        ...
        {mode === "direct" && (
          <div>
            ...
            <Button className="mt-4 border border-[#2C5282] text-[#2C5282] bg-white hover:bg-blue-50" variant="outline" onClick={addDirLine}>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-2">
                ...
                <Button className="bg-[#2C5282] hover:bg-[#1A365D] text-white shadow" onClick={() => { setDlgLine({ serialNumbers: selSerials.join(",") }); setOpenSerialPick(false); }}>Aplicar</Button>
              </div>
            </div>
          </div>
        </DialogContent>
