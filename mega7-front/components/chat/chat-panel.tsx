  ...
  return (
    <>
      ...
      {isOpen && (
        ...
        >
          {/* Header */}
          <div className="flex items-center justify-between px-4 py-3 bg-gradient-to-r from-[#2C5282] to-[#4A7AB5] text-white flex-shrink-0">
          ...
          <div className="flex items-center gap-2 px-3 py-2 border-t border-gray-200 bg-white flex-shrink-0">
            <input
              ...
              maxLength={500}
              className="flex-1 text-sm border border-gray-200 rounded-full px-3 py-1.5 outline-none focus:border-[#2C5282] bg-gray-50 transition"
            />
            <button
              onClick={handleSend}
              disabled={!draft.trim() || !connected}
              className="w-8 h-8 flex items-center justify-center rounded-full bg-[#2C5282] text-white disabled:opacity-40 hover:bg-[#1A365D] transition flex-shrink-0"
            >
              <Send size={14} />
            </button>
          </div>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-[1000] w-12 h-12 rounded-full bg-[#2C5282] hover:bg-[#1A365D] text-white shadow-lg flex items-center justify-center transition hover:scale-105 active:scale-95"
